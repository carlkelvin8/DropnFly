...
export default function BookPage() {
  ...
  const grandTotal = Math.max(0, subtotal + extraFee - promoDiscount);
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const data = {
      ...
      cityOfOrigin: (formData.get("cityOfOrigin") as string) || undefined,
      pickupLocation: getPickupLocationText(),
      dropOffLocation: getDropOffLocationText(),
      numberOfBags: String(totalBags),
      luggageDetails: buildLuggageDetails(luggageQty),
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <header className="sticky top-0 z-50 border-b bg-white/80 shadow-sm backdrop-blur-sm">
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-4">
          ...
          <nav className="flex items-center gap-4">
            <Link href="/track" className="text-sm font-medium text-gray-600 transition-colors hover:text-blue-600">Track</Link>
          </nav>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-2xl px-4 py-12">
        <div className="mb-8 text-center">
          <h1 className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-3xl font-bold text-transparent">Book a Pickup</h1>
        ...
        <div className="mb-8">
          <div className="relative">
            <div className="h-2 w-full rounded-full bg-gray-200">
              <motion.div className="h-2 rounded-full bg-gradient-to-r from-blue-500 to-violet-500" initial={false} animate={{ width: `${progress}%` }} transition={{ duration: 0.4, ease: "easeInOut" }} />
            </div>
              ...
              {steps.map((s) => {
                ...
                return (
                  <div key={s.num} className="flex flex-col items-center">
                    <div className={`flex h-8 w-8 items-center justify-center rounded-full text-xs font-bold transition-all ${isActive ? "bg-gradient-to-r from-blue-600 to-violet-600 text-white shadow-md" : "bg-gray-200 text-gray-400"} ${isCurrent ? "ring-4 ring-blue-200" : ""}`}>
                  ...
                  <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.25 }}>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="countryOfOrigin" name="countryOfOrigin" placeholder="e.g. Philippines" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="cityOfOrigin">City of Origin</Label>
                        <Input id="cityOfOrigin" name="cityOfOrigin" placeholder="e.g. Manila" />
                      </div>
                    </div>
                    <div className="mt-8 flex justify-end">
                      <Button type="button" onClick={nextStep} className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg hover:from-blue-700 hover:to-indigo-700">
                ...
                {step === 2 && (
                  <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.25 }}>
                    ...
                    <div className="mt-8 flex items-center justify-between">
                      ...
                      <Button type="button" onClick={nextStep} disabled={!canGoNext(2)} className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg hover:from-blue-700 hover:to-indigo-700 disabled:opacity-50">
                        Next Step <ArrowRight className="ml-2 h-4 w-4" />
                      </Button>
                    </div>
                  </motion.div>
                    ...
                    <div className="mt-6">
                      ...
                      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                        {LUGGAGE_TYPES.map((lt) => {
                          ...
                          return (
                            <div key={lt.id} className={`relative overflow-hidden rounded-xl border-2 p-3 transition-all ${qty > 0 ? `${lt.color} shadow-md` : "border-gray-200 bg-white hover:border-gray-300"}`}>
                              <div className="mb-2 flex justify-center">
                                <SuitcaseIllustration type={lt} qty={qty} />
                              </div>
                              <div className="text-center">
                                <p className="text-sm font-bold">{lt.name}</p>
                                <p className="mt-0.5 text-[10px] leading-tight text-gray-500">{lt.dimensions}</p>
                              ...
                              <div className="mt-2 flex items-center justify-center gap-1">
                                <button
                                  ...
                                  className="flex h-7 w-7 items-center justify-center rounded-full border border-gray-300 text-gray-600 transition-colors hover:border-blue-400 hover:bg-blue-50 hover:text-blue-600"
                                >
                      ...
                      {totalBags > 0 && (
                        <div className="mt-4 space-y-2 rounded-lg border bg-gray-50/80 p-4">
                ...
                {step === 4 && (
                  <motion.div key="step4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.25 }}>
                    ...
                    <div className="rounded-lg border bg-gray-50/50 p-4 text-sm">
                      ...
                      <div className="mt-3 border-t border-gray-200 pt-3 space-y-1.5">
                        ...
                        <div className="flex justify-between border-t border-gray-300 pt-2 text-base font-bold">
                          ...
                          <span className="text-lg">&#x20B1;{Math.max(0, subtotal + extraFee - promoDiscount).toFixed(2)}</span>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="mb-3 flex gap-2">
                        {[50, 75, 100].map((pct) => (
                          <button
                            ...
                            className={`flex-1 rounded-lg border-2 py-2 text-center text-sm font-bold transition-all ${
                              paymentPercent === pct
                                ? "border-blue-600 bg-blue-600 text-white shadow-md"
                    ...
                    <div className="mt-6 flex items-center justify-between">
                      <Button type="button" variant="outline" onClick={prevStep}><ArrowLeft className="mr-2 h-4 w-4" /> Back</Button>
                      <Button type="submit" className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg hover:from-blue-700 hover:to-indigo-700 hover:shadow-xl" size="lg" disabled={loading}>
                        {loading ? (
