    ...
    const booking = await prisma.$transaction(async (tx) => {
      ...
      return tx.booking.create({
        data: {
          ...
          pickupLat: typeof body.pickupLat === "number" && Number.isFinite(body.pickupLat) ? body.pickupLat : null,
          pickupLng: typeof body.pickupLng === "number" && Number.isFinite(body.pickupLng) ? body.pickupLng : null,
          dropOffLocation: body.dropOffLocation || "",
          dropOffLat: typeof body.dropOffLat === "number" && Number.isFinite(body.dropOffLat) ? body.dropOffLat : null,
          dropOffLng: typeof body.dropOffLng === "number" && Number.isFinite(body.dropOffLng) ? body.dropOffLng : null,
