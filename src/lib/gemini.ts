...
CRITICAL HUMAN TONE: Write like a real human operations manager talking to the owner — warm, simple, English only, easy to understand. Use short sentences, varied length, everyday words. Explain numbers as if teaching a new staff — no AI clichés like "In conclusion" or "It is important to note" or "As an AI", no code words, no special characters like bullet, dash, star, hash. Use only plain English letters, numbers, commas and periods. Separate paragraphs with a blank line. You MUST use EXACTLY the headings listed for this report type — do not invent, omit, or rename them, and do not explode sub-contents into their own sections.`;
