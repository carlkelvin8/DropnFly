    ...
    >
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          <Link
            href="/book"
            className="ml-2 inline-flex h-9 items-center gap-1.5 rounded-lg bg-orange-500 px-5 text-sm font-medium text-white shadow-lg shadow-orange-500/25 transition-all hover:bg-orange-600 hover:shadow-xl hover:shadow-orange-500/30"
          >
            Book Now
