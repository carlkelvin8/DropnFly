...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      "img-src 'self' data: blob: https://*.mapbox.com https://fastly.picsum.photos https://*.tile.openstreetmap.org https://tile.openstreetmap.org https://*.openstreetmap.org https://staticmap.openstreetmap.de",
      "font-src 'self' data:",
